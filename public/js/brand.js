...
const brand = {
    app: {
        name: 'FeatureMeet',
        title: 'FeatureMeet<br />Free browser based Real-time video calls.<br />Simple, Secure, Fast.',
        description:
            'Start your next video call with a single click. No download, plug-in, or login is required. Just get straight to talking, messaging, and sharing your screen.',
    },
    site: {
        landingTitle: 'FeatureMeet a Free Secure Video Calls, Chat & Screen Sharing.',
        newCallTitle: 'FeatureMeet a Free Secure Video Calls, Chat & Screen Sharing.',
        loginTitle: 'FeatureMeet - Host Protected login required.',
        clientTitle: 'FeatureMeet WebRTC Video call, Chat Room & Screen Sharing.',
        privacyPolicyTitle: 'FeatureMeet - privacy and policy.',
        stunTurnTitle: 'Test Stun/Turn Servers.',
        notFoundTitle: 'FeatureMeet - 404 Page not found.',
