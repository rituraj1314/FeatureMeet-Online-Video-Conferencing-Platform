...
/**
 * FeatureMeet P2P - Client component
 *
...
/**
 * Configuration for controlling the visibility of buttons in the FeatureMeet P2P client.
...
function shareRoomByEmail() {
    Swal.fire({
        ...
        preConfirm: () => {
            ...
            const email = '';
            const emailSubject = `Please join our FeatureMeet P2P Video Chat Meeting`;
    ...
    Swal.fire({
        ...
        <div id="about">
            ...
            Email:<a 
                ...
                href="mailto:miroslav.pejic.85@gmail.com?subject=FeatureMeet P2P info"> 
...
function leaveFeedback() {
    Swal.fire({
        ...
        text: 'Do you want to rate your FeatureMeet experience?',
        confirmButtonText: `Yes`,
        denyButtonText: `No`,
        showClass: { popup: 'animate__animated animate__fadeInDown' },
        hideClass: { popup: 'animate__animated animate__fadeOutUp' },
